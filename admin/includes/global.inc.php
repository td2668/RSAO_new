...
function validateUsingTable($username,$password) {
    ...
    return ($sessionConfig["usertable"][$username]==$md5pass);	// return if there is a matche
}
...
function parseXMLsitemap(& $tmpl,$page) {
	global $sitemapXML,$XMLsitemapParsed;
	...
	foreach($sitemapXML as $key => $item) {
        ...
        */
    if($page=='index') $image="<a href='/content.php?page=research_forms'><img border='0' src='/images/plate-forms.jpg' style='margin-left: 10px; margin-top: 60px;' /></a>";
    else $image='';
...
*/
function displayBlankPage($title,$contents) {
        ...
        $sql = "
            SELECT u.first_name, u.last_name, u.department_id, u.department2_id, d1.division_id,
                ...
                p1.email, p1.title, p1.secondary_title, p1.office, p1.phone, p1.fax,
                    p1.homepage, p1.profile_ext, p1.profile_short, p1.keywords, p1.description,
                p2.*,
