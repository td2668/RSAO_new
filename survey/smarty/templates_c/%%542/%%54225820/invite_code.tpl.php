<?php /* Smarty version 2.3.0, created on 2009-04-01 08:50:21
         compiled from Default/invite_code.tpl */ ?>
...
">
        ...
        <input type="text" name="invite_code" value="<?php echo $this->_tpl_vars['data']['invite_code']; ?>
" size="21" maxlength="25">
        <br>
