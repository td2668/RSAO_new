<?php /* Smarty version 2.3.0, created on 2009-01-20 09:07:53
         compiled from Default/take_survey.tpl */ ?>
<?php $this->_load_plugins(array(
array('modifier', 'default', 'Default/take_survey.tpl', 43, false),)); ?><form method="POST" action="survey.php">
...
?>
          <div>
            Page <?php echo $this->_tpl_vars['survey']['page']; ?>
 of <?php echo $this->_tpl_vars['survey']['total_pages']; ?>
...
?>
          <div>
            Time Limit: <?php echo $this->_tpl_vars['survey']['time_limit']; ?>
 minutes. Approximate Elapsed Time: <?php echo $this->_tpl_vars['survey']['elapsed_minutes']; ?>
...
/index.php">Return to Main Menu</a> ]
          </div>
        <?php endfor; endif; ?>
...
?>
              &nbsp;
              <input type="submit" name="previous" value="<?php echo $this->_run_mod_handler('default', true, $this->_tpl_vars['button']['previous'], "&lt;&lt;&nbsp;Previous Page"); ?>
">
            <?php endfor; endif; ?>
...
?>
              &nbsp;
              <input type="submit" name="next" value="<?php echo $this->_run_mod_handler('default', true, $this->_tpl_vars['button']['next'], "Next Page&nbsp;&gt;&gt;"); ?>
">
            <?php endfor; endif; ?>
          </div>
      </td>
