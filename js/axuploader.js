		...
		init : function(options)
		{
    	    ...
    	    return this.each(function() 
    	    {
			   ...
			   // isAjaxUpload=false;
				...
				\*================================================================================*/
				var clear=$('<input style="margin-left:5px;" type="button" value="Clear" class="ax-clear" /><br/><br/>').appendTo(mainForm).bind('click',function(){
					fileCount=0;
					totalFiles=0;
				...
				function add_file(t,o,n,s,numF)
				{
					...
					var div_p=$('<div  class="ax-progress-div" />').css({'width':'0%','background-color':'lightgreen'}).html(0).appendTo(td_p);
