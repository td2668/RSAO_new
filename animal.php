...
$tmpl=loadPage("animal", 'Animal Care');

showMenu("compliance");
//2010-12-29 TD - Removed so that ACC does not show on website for security reasons.
/*
$sql="  select * from committee_members
        ...
        where committees.name = 'Animal Care Committee' 
