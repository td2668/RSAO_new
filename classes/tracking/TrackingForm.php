...
use Email;
use Exception;
use tracking\notifications\ORSNotification;
use tracking\notifications\HREBNotification;
use tracking\notifications\DeanNotification;
use tracking\notifications\ResearcherNotification;

require_once('includes/global.inc.php');

require_once('classes/tracking/Funding.php');
require_once('classes/tracking/Commitments.php');
require_once('classes/tracking/Investigator.php');
require_once('classes/tracking/ExternalInvestigator.php');
require_once('classes/tracking/COI.php');
require_once('classes/tracking/Compliance.php');
...
class TrackingForm
{
    ...
    /*
     * Whether this tracking form has COI's declared that require review
     */
    ...
    /*
     * How many persons with COI's this form has
     */
...
', $this->trackingFormId, $this->projectTitle, html_entity_decode(strip_tags($deanComments)));
    ...
    /**
     * Get the files associated with this tracking form
     *
